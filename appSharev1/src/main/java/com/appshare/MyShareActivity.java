...
import com.appshare.adapter.MyShareListAdapter;
...
public class MyShareActivity extends Activity{
	...
	private ShareListAdapter myshareadapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ptrlist = (PullToRefreshListView) findViewById(R.id.my_share_list);
		mysharelist = ptrlist.getRefreshableView();
		init();
        ShareList();
		back_btn=(Button)findViewById(R.id.my_share_return_btn);
		...
		ptrlist.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
			...
			public void onPullDownToRefresh(
				...
				// TODO Auto-generated method stub
				String label = DateUtils.formatDateTime(MyShareActivity.this,
		...
		mysharelist.setOnItemClickListener(new OnItemClickListener() {
	...
	private void init() {
        ...
        endLabels.setReleaseLabel(this.getResources().getString(R.string.loadend));// �����ﵽһ������ʱ����ʾ����ʾʾ
	}
	...
	private class DownFinishRefresh extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void result) {
            ...
            myshareadapter = new ShareListAdapter(MyShareActivity.this, shares);
            mysharelist.setAdapter(myshareadapter);
		}
	}
        ...
        new AsyncTask<String, Float, String>(){
            ...
            protected String doInBackground(String... arg0){
                ...
                try {
                    ...
                    String nurl=SERVER+"/share.php?uid="+user_id;
